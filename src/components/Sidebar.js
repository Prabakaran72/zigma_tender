  ...
  return (
    ...
    >
      ...
      <hr className="sidebar-divider my-0" />
        ...
        >
        <div className="bg-white py-2 collapse-inner rounded">
            <Link className={`collapse-item ${active === "coustomerCreationTab"? "active":""}`} to={`/${pathName}/tendercreation`} onClick = {() => hideSidebarElement("MasterMenu", "coustomerCreationTab")}>
              Customer Creation
            </Link>
            <Link className={`collapse-item ${active === "competitorCreationTab"? "active":""}`} to={`/${pathName}/tendertracker`} onClick = {() => hideSidebarElement("MasterMenu", "competitorCreationTab")}>
              Competitor Creation
            </Link>
          </div>
        </div>
